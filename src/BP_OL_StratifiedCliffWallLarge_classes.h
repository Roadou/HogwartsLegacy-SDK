// BlueprintGeneratedClass BP_OL_StratifiedCliffWallLarge.BP_OL_StratifiedCliffWallLarge_C
// Size: 0x428 (Inherited: 0x3c0)
struct ABP_OL_StratifiedCliffWallLarge_C : ABP_OL_Spline_Parent_C {
	...
	void UserConstructionScript(); // Function BP_OL_StratifiedCliffWallLarge.BP_OL_StratifiedCliffWallLarge_C.UserConstructionScript // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x38a7480
};
