// AnimBlueprintGeneratedClass ABP_Kneazle_Creature.ABP_Kneazle_Creature_C
// Size: 0xaa0 (Inherited: 0x670)
struct UABP_Kneazle_Creature_C : UNPC_AnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function ABP_Kneazle_Creature.ABP_Kneazle_Creature_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x38a7480
	void ExecuteUbergraph_ABP_Kneazle_Creature(int32_t EntryPoint); // Function ABP_Kneazle_Creature.ABP_Kneazle_Creature_C.ExecuteUbergraph_ABP_Kneazle_Creature // (Final|UbergraphFunction) // @ game+0x38a7480
};
