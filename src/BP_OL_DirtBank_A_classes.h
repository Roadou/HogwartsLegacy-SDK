// BlueprintGeneratedClass BP_OL_DirtBank_A.BP_OL_DirtBank_A_C
// Size: 0x3f9 (Inherited: 0x3c0)
struct ABP_OL_DirtBank_A_C : ABP_OL_Spline_Parent_C {
	...
	void UserConstructionScript(); // Function BP_OL_DirtBank_A.BP_OL_DirtBank_A_C.UserConstructionScript // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x38a7480
};
