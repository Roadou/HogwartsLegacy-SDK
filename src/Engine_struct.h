...
// Enum Engine.EVisibilityGroupMask
enum class EVisibilityGroupMask : uint8 {
	Unset = 1,
	Inside = 2,
	Outside = 4,
	InsideOutside = 8,
...
// Enum Engine.EEvaluatorRootMotion
enum class EEvaluatorRootMotion : uint8 {
	ERM_Standard = 0,
	ERM_NoRootMotion = 1,
...
// Enum Engine.EInsideVolumeOptions
enum class EInsideVolumeOptions : uint8 {
	ProbeLighting = 0,
	Audio = 1,
	Streaming = 2,
	Game = 3,
...
// Enum Engine.EFXMaskFlags
enum class EFXMaskFlags : uint8 {
	Wind = 0,
	Fog = 1,
	Precipitation = 2,
	EFXMaskFlags_MAX = 3
...
// Enum Engine.EGameThreadTimeAllocatedSections
enum class EGameThreadTimeAllocatedSections : uint8 {
	GarbageCollection = 0,
...
// Enum Engine.EShadowQualityLevels
enum class EShadowQualityLevels : uint8 {
	Low = 0,
	Medium = 1,
	High = 2,
	Epic = 3,
...
// Enum Engine.ELightClippingProviderInsideVolumeMode
enum class ELightClippingProviderInsideVolumeMode : uint8 {
	Inside = 0,
	Outside = 1,
	ELightClippingProviderInsideVolumeMode_MAX = 2
};

// Enum Engine.EWISMCNumCustomDataFloat
enum class EWISMCNumCustomDataFloat : uint8 {
	WNumCDF_None = 0,
	WNumCDF_4Floats = 1,
	WNumCDF_8Floats = 2,
	WNumCDF_12Floats = 3,
...
// Enum Engine.ELightClippingProviderVolumeMode
enum class ELightClippingProviderVolumeMode : uint8 {
	Inside = 0,
	Outside = 1,
	ELightClippingProviderVolumeMode_MAX = 2
};

// Enum Engine.ELightCullingPriority
enum class ELightCullingPriority : uint8 {
	Low = 0,
	Default = 1,
	High = 2,
	Ultra = 3,
...
// Enum Engine.MaterialQLTypeMeta
enum class MaterialQLTypeMeta : int32 {
	MQL_None = -1,
	MQL_Low = 0,
	MQL_Medium = 2,
	MQL_High = 1,
...
// Enum Engine.EAvaReflectionTimeType
enum class EAvaReflectionTimeType : uint8 {
	None = 0,
	Hour = 1,
	Timeslot = 2,
...
// Enum Engine.EAvaReflectionCullType
enum class EAvaReflectionCullType : uint8 {
	Everywhere = 0,
	Outside = 1,
	Inside = 2,
...
// Enum Engine.ECubeCaptureFace
enum class ECubeCaptureFace : uint8 {
	PosX = 0,
	NegX = 1,
	PosY = 2,
	NegY = 3,
...
// Enum Engine.EMaskTextureChannel
...
// Enum Engine.EIDMaskPackingType
enum class EIDMaskPackingType : uint8 {
	IDT_IDPacked = 0,
	IDT_IDAlpha = 1,
	IDT_MAX = 2
};
...
// Enum Engine.EWindGustCurveRemap
enum class EWindGustCurveRemap : uint8 {
	None = 0,
	Clamped = 1,
	Unclamped = 2,
	Limit = 3,
...
// Enum Engine.EWindGustSpeedOp
enum class EWindGustSpeedOp : uint8 {
	Multiply = 0,
	Add = 1,
	Subtract = 2,
	Replace = 3,
...
// Enum Engine.EWindSourceCombine
enum class EWindSourceCombine : uint8 {
	Add = 0,
	Subtract = 1,
	Replace = 2,
...
// Enum Engine.EWCullingVolumeRemoveType
enum class EWCullingVolumeRemoveType : uint8 {
	Remove = 0,
	AverageNeighbors = 1,
	EWCullingVolumeRemoveType_MAX = 2
};

// Enum Engine.EWCullingVolumeAreaType
enum class EWCullingVolumeAreaType : uint8 {
	Area = 0,
	Point = 1,
	EWCullingVolumeAreaType_MAX = 2
};

// Enum Engine.EWLightProbeCompressionType
enum class EWLightProbeCompressionType : uint8 {
	None = 0,
	YCoCg = 1,
	MAX = 2
};

// Enum Engine.EWLightProbesCorrectionType
enum class EWLightProbesCorrectionType : uint8 {
	Basic = 0,
	Advanced = 1,
	EWLightProbesCorrectionType_MAX = 2
};

// Enum Engine.EWLightProbesConfiguration
enum class EWLightProbesConfiguration : uint8 {
	Manual = 0,
	LQGI = 1,
	HQGI = 2,
	EWLightProbesConfiguration_MAX = 3
};

// Enum Engine.EWLightProbesShapeType
enum class EWLightProbesShapeType : uint8 {
	Cube = 0,
	Cylinder = 1,
	MAX = 2
};

// Enum Engine.EWLightProbesLandscapeUsage
enum class EWLightProbesLandscapeUsage : uint8 {
	Anywhere = 0,
	OnlyAbove = 1,
	OnlyBelow = 2,
...
// Enum Engine.EWLightProbesSkylightUsage
enum class EWLightProbesSkylightUsage : uint8 {
	On = 0,
	Off = 1,
	EWLightProbesSkylightUsage_MAX = 2
};

// Enum Engine.EWLightProbesCullType
enum class EWLightProbesCullType : uint8 {
	Default = 0,
	Outside = 1,
	Inside = 2,
...
// Enum Engine.EWLightProbesBlendType
enum class EWLightProbesBlendType : uint8 {
	Blend = 0,
	Additive = 1,
	EWLightProbesBlendType_MAX = 2
};

// Enum Engine.EWLightProbesDebugType
enum class EWLightProbesDebugType : uint8 {
	NoDebugDisplay = 0,
	Radiance = 1,
	Irradiance = 2,
	SkyOcclusion = 3,
...
// Enum Engine.EWLightProbesCaptureType
enum class EWLightProbesCaptureType : uint8 {
	Default = 0,
	Intermediate = 1,
	Cinematic = 2,
	EWLightProbesCaptureType_MAX = 3
};

// Enum Engine.EWorldCalcSceneViewType
enum class EWorldCalcSceneViewType : uint8 {
	Player = 0,
	UMG = 1,
	Editor = 2,
	TimeRigEditor = 3,
...
struct FMaterialAttributesInput : FExpressionInput {
	...
	uint64_t PropertyConnectedBitmask; // 0x18(0x08)
};
...
// ScriptStruct Engine.RuntimeCurveVector
...
struct FRootMotionMovementParams {
	...
	float RotationBlendWeight; // 0x08(0x04)
	enum class ETeleportType TeleportType; // 0x0c(0x01)
...
struct FPostProcessSettings {
	...
	char bOverride_BloomCross : 1; // 0x06(0x01)
	...
	char bOverride_AutoExposureBiasVFX : 1; // 0x0b(0x01)
	...
	char bOverride_PreExposureResetValue : 1; // 0x0b(0x01)
	char bOverride_PreExposureMinValue : 1; // 0x0c(0x01)
	char bOverride_PreExposureMaxValue : 1; // 0x0c(0x01)
	...
	char bOverride_AmbientOcclusionSkinIntensity : 1; // 0x0f(0x01)
	...
	char bOverride_SimpleLightDemotionDistance : 1; // 0x15(0x01)
	char bOverride_SimpleLightSpecularFadeEndMultiplier : 1; // 0x16(0x01)
	char bOverride_IndirectLightingColor : 1; // 0x16(0x01)
	char bOverride_IndirectLightingIntensity : 1; // 0x16(0x01)
	char bOverride_ProbeToneMapAmount : 1; // 0x16(0x01)
	char bOverride_ProbeToneMapMinIntensity : 1; // 0x16(0x01)
	char bOverride_ProbeToneMapMaxEV : 1; // 0x16(0x01)
	char bOverride_ProbeOutsideIntensity : 1; // 0x16(0x01)
	char bOverride_ProbeInsideIntensity : 1; // 0x16(0x01)
	char bOverride_ProbeOutsideSaturation : 1; // 0x17(0x01)
	char bOverride_ProbeInsideSaturation : 1; // 0x17(0x01)
	char bOverride_ProbeSamplePositionMultiplier : 1; // 0x17(0x01)
	char bOverride_ProbeSamplePositionMin : 1; // 0x17(0x01)
	char bOverride_ProbeSamplePositionMax : 1; // 0x17(0x01)
	char bOverride_ProbeContactShadowsMinValue : 1; // 0x17(0x01)
	char bOverride_ProbeContactShadowsLength : 1; // 0x17(0x01)
	char bOverride_ProbeContactShadowsConeAngle : 1; // 0x17(0x01)
	char bOverride_ProbeContactShadowsFalloffExponent : 1; // 0x18(0x01)
	char bOverride_ProbeContactShadowsDepthTolerance : 1; // 0x18(0x01)
	char bOverride_ColorGradingIntensity : 1; // 0x18(0x01)
	char bOverride_ColorGradingLUT : 1; // 0x18(0x01)
	char bOverride_DepthOfFieldFocalDistance : 1; // 0x18(0x01)
	char bOverride_DepthOfFieldFstop : 1; // 0x18(0x01)
	char bOverride_DepthOfFieldMinFstop : 1; // 0x18(0x01)
	char bOverride_DepthOfFieldBladeCount : 1; // 0x18(0x01)
	char bOverride_DepthOfFieldSensorWidth : 1; // 0x19(0x01)
	char bOverride_DepthOfFieldDepthBlurRadius : 1; // 0x19(0x01)
	char bOverride_DepthOfFieldDepthBlurAmount : 1; // 0x19(0x01)
	char bOverride_DepthOfFieldFocalRegion : 1; // 0x19(0x01)
	char bOverride_DepthOfFieldNearTransitionRegion : 1; // 0x19(0x01)
	char bOverride_DepthOfFieldFarTransitionRegion : 1; // 0x19(0x01)
	char bOverride_DepthOfFieldScale : 1; // 0x19(0x01)
	char bOverride_DepthOfFieldNearBlurSize : 1; // 0x19(0x01)
	char bOverride_DepthOfFieldFarBlurSize : 1; // 0x1a(0x01)
	char bOverride_MobileHQGaussian : 1; // 0x1a(0x01)
	char bOverride_DepthOfFieldOcclusion : 1; // 0x1a(0x01)
	char bOverride_DepthOfFieldSkyFocusDistance : 1; // 0x1a(0x01)
	char bOverride_DepthOfFieldVignetteSize : 1; // 0x1a(0x01)
	char bOverride_MotionBlurAmount : 1; // 0x1a(0x01)
	char bOverride_MotionBlurMax : 1; // 0x1a(0x01)
	char bOverride_MotionBlurTargetFPS : 1; // 0x1a(0x01)
	char bOverride_MotionBlurPerObjectSize : 1; // 0x1b(0x01)
	char bOverride_ScreenPercentage : 1; // 0x1b(0x01)
	char bOverride_ScreenSpaceReflectionIntensity : 1; // 0x1b(0x01)
	char bOverride_ScreenSpaceReflectionQuality : 1; // 0x1b(0x01)
	char bOverride_ScreenSpaceReflectionMaxRoughness : 1; // 0x1b(0x01)
	char bOverride_ScreenSpaceReflectionRoughnessScale : 1; // 0x1b(0x01)
	char pad_1B_6 : 2; // 0x1b(0x01)
	char bOverride_ReflectionsType : 1; // 0x1c(0x01)
	char pad_1C_1 : 7; // 0x1c(0x01)
	char pad_1D[0x3]; // 0x1d(0x03)
	char bOverride_ReflectionCaptureOutsideSaturation : 1; // 0x20(0x01)
	char bOverride_ReflectionCaptureOutsideColorTint : 1; // 0x20(0x01)
	char bOverride_ReflectionCaptureInsideSaturation : 1; // 0x20(0x01)
	char bOverride_ReflectionCaptureInsideColorTint : 1; // 0x20(0x01)
	...
	char bOverride_RayTracingTranslucencyRefractionRays : 1; // 0x24(0x01)
	...
	char bOverride_PathTracingSamplesPerPixel : 1; // 0x25(0x01)
	char bOverride_PathTracingFilterWidth : 1; // 0x26(0x01)
	char bOverride_PathTracingEnableEmissive : 1; // 0x26(0x01)
	char bOverride_PathTracingMaxPathExposure : 1; // 0x26(0x01)
	char bOverride_PathTracingEnableDenoiser : 1; // 0x26(0x01)
	char pad_26_4 : 4; // 0x26(0x01)
	...
	float BloomCross; // 0x234(0x04)
	float BloomSizeScale; // 0x238(0x04)
	float Bloom1Size; // 0x23c(0x04)
	float Bloom2Size; // 0x240(0x04)
	float Bloom3Size; // 0x244(0x04)
	float Bloom4Size; // 0x248(0x04)
	float Bloom5Size; // 0x24c(0x04)
	float Bloom6Size; // 0x250(0x04)
	struct FLinearColor Bloom1Tint; // 0x254(0x10)
	struct FLinearColor Bloom2Tint; // 0x264(0x10)
	struct FLinearColor Bloom3Tint; // 0x274(0x10)
	struct FLinearColor Bloom4Tint; // 0x284(0x10)
	struct FLinearColor Bloom5Tint; // 0x294(0x10)
	struct FLinearColor Bloom6Tint; // 0x2a4(0x10)
	float BloomConvolutionSize; // 0x2b4(0x04)
	...
	float AutoExposureBiasVFX; // 0x328(0x04)
	float AutoExposureBiasBackup; // 0x32c(0x04)
	char bOverride_AutoExposureBiasBackup : 1; // 0x330(0x01)
	char pad_330_1 : 7; // 0x330(0x01)
	char pad_331[0x3]; // 0x331(0x03)
	char AutoExposureApplyPhysicalCameraExposure : 1; // 0x334(0x01)
	...
	float PreExposureResetValue; // 0x368(0x04)
	float PreExposureMinValue; // 0x36c(0x04)
	float PreExposureMaxValue; // 0x370(0x04)
	float AutoExposureCalibrationConstant; // 0x374(0x04)
	float LensFlareIntensity; // 0x378(0x04)
	struct FLinearColor LensFlareTint; // 0x37c(0x10)
	float LensFlareBokehSize; // 0x38c(0x04)
	float LensFlareThreshold; // 0x390(0x04)
	char pad_394[0x4]; // 0x394(0x04)
	struct UTexture* LensFlareBokehShape; // 0x398(0x08)
	struct FLinearColor LensFlareTints[0x8]; // 0x3a0(0x80)
	float VignetteIntensity; // 0x420(0x04)
	float GrainJitter; // 0x424(0x04)
	float GrainIntensity; // 0x428(0x04)
	float AmbientOcclusionIntensity; // 0x42c(0x04)
	float AmbientOcclusionStaticFraction; // 0x430(0x04)
	float AmbientOcclusionRadius; // 0x434(0x04)
	char AmbientOcclusionRadiusInWS : 1; // 0x438(0x01)
	char pad_438_1 : 7; // 0x438(0x01)
	char pad_439[0x3]; // 0x439(0x03)
	float AmbientOcclusionFadeDistance; // 0x43c(0x04)
	float AmbientOcclusionFadeRadius; // 0x440(0x04)
	float AmbientOcclusionDistance; // 0x444(0x04)
	float AmbientOcclusionPower; // 0x448(0x04)
	float AmbientOcclusionBias; // 0x44c(0x04)
	float AmbientOcclusionQuality; // 0x450(0x04)
	float AmbientOcclusionMipBlend; // 0x454(0x04)
	float AmbientOcclusionMipScale; // 0x458(0x04)
	float AmbientOcclusionMipThreshold; // 0x45c(0x04)
	float AmbientOcclusionTemporalBlendWeight; // 0x460(0x04)
	char RayTracingAO : 1; // 0x464(0x01)
	char pad_464_1 : 7; // 0x464(0x01)
	char pad_465[0x3]; // 0x465(0x03)
	float AmbientOcclusionSkinIntensity; // 0x468(0x04)
	int32_t RayTracingAOSamplesPerPixel; // 0x46c(0x04)
	float RayTracingAOIntensity; // 0x470(0x04)
	float RayTracingAORadius; // 0x474(0x04)
	struct FLinearColor IndirectLightingColor; // 0x478(0x10)
	float IndirectLightingIntensity; // 0x488(0x04)
	float ProbeToneMapAmount; // 0x48c(0x04)
	float ProbeToneMapMinIntensity; // 0x490(0x04)
	float ProbeToneMapMaxEV; // 0x494(0x04)
	float ProbeOutsideIntensity; // 0x498(0x04)
	float ProbeInsideIntensity; // 0x49c(0x04)
	float ProbeOutsideSaturation; // 0x4a0(0x04)
	float ProbeInsideSaturation; // 0x4a4(0x04)
	float ProbeSamplePositionMultiplier; // 0x4a8(0x04)
	float ProbeSamplePositionMin; // 0x4ac(0x04)
	float ProbeSamplePositionMax; // 0x4b0(0x04)
	float ProbeContactShadowsMinValue; // 0x4b4(0x04)
	float ProbeContactShadowsLength; // 0x4b8(0x04)
	float ProbeContactShadowsConeAngle; // 0x4bc(0x04)
	float ProbeContactShadowsFalloffExponent; // 0x4c0(0x04)
	float ProbeContactShadowsDepthTolerance; // 0x4c4(0x04)
	enum class ERayTracingGlobalIlluminationType RayTracingGIType; // 0x4c8(0x01)
	char pad_4C9[0x3]; // 0x4c9(0x03)
	int32_t RayTracingGIMaxBounces; // 0x4cc(0x04)
	int32_t RayTracingGISamplesPerPixel; // 0x4d0(0x04)
	float ColorGradingIntensity; // 0x4d4(0x04)
	struct UTexture* ColorGradingLUT; // 0x4d8(0x08)
	float DepthOfFieldSensorWidth; // 0x4e0(0x04)
	float DepthOfFieldFocalDistance; // 0x4e4(0x04)
	float DepthOfFieldDepthBlurAmount; // 0x4e8(0x04)
	float DepthOfFieldDepthBlurRadius; // 0x4ec(0x04)
	float DepthOfFieldFocalRegion; // 0x4f0(0x04)
	float DepthOfFieldNearTransitionRegion; // 0x4f4(0x04)
	float DepthOfFieldFarTransitionRegion; // 0x4f8(0x04)
	float DepthOfFieldScale; // 0x4fc(0x04)
	float DepthOfFieldNearBlurSize; // 0x500(0x04)
	float DepthOfFieldFarBlurSize; // 0x504(0x04)
	float DepthOfFieldOcclusion; // 0x508(0x04)
	float DepthOfFieldSkyFocusDistance; // 0x50c(0x04)
	float DepthOfFieldVignetteSize; // 0x510(0x04)
	float MotionBlurAmount; // 0x514(0x04)
	float MotionBlurMax; // 0x518(0x04)
	int32_t MotionBlurTargetFPS; // 0x51c(0x04)
	float MotionBlurPerObjectSize; // 0x520(0x04)
	float LPVIntensity; // 0x524(0x04)
	float LPVVplInjectionBias; // 0x528(0x04)
	float LPVSize; // 0x52c(0x04)
	float LPVSecondaryOcclusionIntensity; // 0x530(0x04)
	float LPVSecondaryBounceIntensity; // 0x534(0x04)
	float LPVGeometryVolumeBias; // 0x538(0x04)
	float LPVEmissiveInjectionIntensity; // 0x53c(0x04)
	float LPVDirectionalOcclusionIntensity; // 0x540(0x04)
	float LPVDirectionalOcclusionRadius; // 0x544(0x04)
	float LPVDiffuseOcclusionExponent; // 0x548(0x04)
	float LPVSpecularOcclusionExponent; // 0x54c(0x04)
	float LPVDiffuseOcclusionIntensity; // 0x550(0x04)
	float LPVSpecularOcclusionIntensity; // 0x554(0x04)
	enum class EReflectionsType ReflectionsType; // 0x558(0x01)
	char pad_559[0x3]; // 0x559(0x03)
	float ReflectionCaptureOutsideSaturation; // 0x55c(0x04)
	struct FLinearColor ReflectionCaptureOutsideColorTint; // 0x560(0x10)
	float ReflectionCaptureInsideSaturation; // 0x570(0x04)
	struct FLinearColor ReflectionCaptureInsideColorTint; // 0x574(0x10)
	float ScreenSpaceReflectionIntensity; // 0x584(0x04)
	float ScreenSpaceReflectionQuality; // 0x588(0x04)
	float ScreenSpaceReflectionMaxRoughness; // 0x58c(0x04)
	float RayTracingReflectionsMaxRoughness; // 0x590(0x04)
	int32_t RayTracingReflectionsMaxBounces; // 0x594(0x04)
	int32_t RayTracingReflectionsSamplesPerPixel; // 0x598(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingReflectionsShadows; // 0x59c(0x01)
	char RayTracingReflectionsTranslucency : 1; // 0x59d(0x01)
	char pad_59D_1 : 7; // 0x59d(0x01)
	enum class ETranslucencyType TranslucencyType; // 0x59e(0x01)
	char pad_59F[0x1]; // 0x59f(0x01)
	float RayTracingTranslucencyMaxRoughness; // 0x5a0(0x04)
	int32_t RayTracingTranslucencyRefractionRays; // 0x5a4(0x04)
	int32_t RayTracingTranslucencySamplesPerPixel; // 0x5a8(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingTranslucencyShadows; // 0x5ac(0x01)
	char RayTracingTranslucencyRefraction : 1; // 0x5ad(0x01)
	char pad_5AD_1 : 7; // 0x5ad(0x01)
	char pad_5AE[0x2]; // 0x5ae(0x02)
	int32_t PathTracingMaxBounces; // 0x5b0(0x04)
	int32_t PathTracingSamplesPerPixel; // 0x5b4(0x04)
	float PathTracingFilterWidth; // 0x5b8(0x04)
	char PathTracingEnableEmissive : 1; // 0x5bc(0x01)
	char pad_5BC_1 : 7; // 0x5bc(0x01)
	char pad_5BD[0x3]; // 0x5bd(0x03)
	float PathTracingMaxPathExposure; // 0x5c0(0x04)
	char PathTracingEnableDenoiser : 1; // 0x5c4(0x01)
	char pad_5C4_1 : 7; // 0x5c4(0x01)
	char pad_5C5[0x3]; // 0x5c5(0x03)
	float LPVFadeRange; // 0x5c8(0x04)
	float LPVDirectionalOcclusionFadeRange; // 0x5cc(0x04)
	float SimpleLightDemotionDistance; // 0x5d0(0x04)
	float SimpleLightSpecularFadeEndMultiplier; // 0x5d4(0x04)
	float ScreenPercentage; // 0x5d8(0x04)
	char pad_5DC[0x4]; // 0x5dc(0x04)
	struct FWeightedBlendables WeightedBlendables; // 0x5e0(0x10)
};
...
// ScriptStruct Engine.WLightProbesCaptureEvaluator
// Size: 0x08 (Inherited: 0x00)
struct FWLightProbesCaptureEvaluator {
	char pad_0[0x8]; // 0x00(0x08)
};

// ScriptStruct Engine.WLightProbesBlendData
// Size: 0x0c (Inherited: 0x00)
struct FWLightProbesBlendData {
	int32_t TexIndex1; // 0x00(0x04)
	int32_t TexIndex2; // 0x04(0x04)
	float BlendValue; // 0x08(0x04)
};
...
struct FAnimNode_TransitionPoseEvaluator : FAnimNode_Base {
	...
	enum class EEvaluatorRootMotion RootMotionMode; // 0xf2(0x01)
...
struct FAtmospherePrecomputeParameters {
	...
	struct FAtmospherePrecomputeFullParameters FullParams; // 0x04(0x28)
	float DecayHeight; // 0x2c(0x04)
	int32_t MaxScatteringOrder; // 0x30(0x04)
	int32_t TransmittanceTexWidth; // 0x34(0x04)
	int32_t TransmittanceTexHeight; // 0x38(0x04)
	int32_t IrradianceTexWidth; // 0x3c(0x04)
	int32_t IrradianceTexHeight; // 0x40(0x04)
	int32_t InscatterAltitudeSampleNum; // 0x44(0x04)
	int32_t InscatterMuNum; // 0x48(0x04)
	int32_t InscatterMuSNum; // 0x4c(0x04)
	int32_t InscatterNuNum; // 0x50(0x04)
	bool bUseFullParams; // 0x54(0x01)
	char pad_55[0x3]; // 0x55(0x03)
};

// ScriptStruct Engine.AtmospherePrecomputeFullParameters
// Size: 0x28 (Inherited: 0x00)
struct FAtmospherePrecomputeFullParameters {
	float RayleighHeight; // 0x00(0x04)
	float MieHeight; // 0x04(0x04)
	struct FVector BetaMieScattering; // 0x08(0x0c)
	float MieG; // 0x14(0x04)
	struct FVector BetaRayleighScattering; // 0x18(0x0c)
	float BetaMieRatio; // 0x24(0x04)
};
...
// ScriptStruct Engine.InsideVolumeOptionsMask
// Size: 0x04 (Inherited: 0x00)
struct FInsideVolumeOptionsMask {
	int32_t Mask; // 0x00(0x04)
};

// ScriptStruct Engine.InsideVolumeDistanceField
// Size: 0x18 (Inherited: 0x00)
struct FInsideVolumeDistanceField {
	struct TArray<char> CompressedDistanceField; // 0x00(0x10)
	struct FVector2D DistanceMinMax; // 0x10(0x08)
};
...
// Size: 0x620 (Inherited: 0x00)
struct FCameraShakeUpdateResult {
	char pad_0[0x620]; // 0x00(0x620)
};
...
struct FCameraShakeScrubParams {
	...
	struct FMinimalViewInfo POV; // 0x10(0x680)
};
...
struct FMinimalViewInfo {
	...
	struct FVector2D OffCenterProjectionOffset; // 0x630(0x08)
	char pad_638[0x48]; // 0x638(0x48)
};
...
struct FConstraintInstance : FConstraintInstanceBase {
	...
	struct FConstraintProfileProperties ProfileInstance; // 0x8c(0x118)
...
struct FConstraintProfileProperties {
	...
	struct FLinearConstraint LinearLimit; // 0x24(0x1c)
	struct FConeConstraint ConeLimit; // 0x40(0x20)
	struct FTwistConstraint TwistLimit; // 0x60(0x1c)
	struct FLinearDriveConstraint LinearDrive; // 0x7c(0x4c)
	struct FAngularDriveConstraint AngularDrive; // 0xc8(0x4c)
	char bDisableCollision : 1; // 0x114(0x01)
	char bParentDominates : 1; // 0x114(0x01)
	char bEnableLinearProjection : 1; // 0x114(0x01)
	char bEnableAngularProjection : 1; // 0x114(0x01)
	char bEnableShockPropagation : 1; // 0x114(0x01)
	char bEnableProjection : 1; // 0x114(0x01)
	char bEnableSoftProjection : 1; // 0x114(0x01)
	char bAngularBreakable : 1; // 0x114(0x01)
	char bAngularPlasticity : 1; // 0x115(0x01)
	char bLinearBreakable : 1; // 0x115(0x01)
	char bLinearPlasticity : 1; // 0x115(0x01)
	char pad_115_3 : 5; // 0x115(0x01)
...
// ScriptStruct Engine.RuntimeCurveVector2D
// Size: 0x108 (Inherited: 0x00)
struct FRuntimeCurveVector2D {
	struct FRichCurve VectorCurves[0x2]; // 0x00(0x100)
	struct UCurveVector2D* ExternalCurve; // 0x100(0x08)
};
...
struct FAnimUpdateRateParameters {
	...
	char bForceTrailMode : 1; // 0x02(0x01)
	char pad_2_6 : 2; // 0x02(0x01)
	char pad_3[0x1]; // 0x03(0x01)
	int32_t ForceRate; // 0x04(0x04)
	int32_t UpdateRate; // 0x08(0x04)
	int32_t EvaluationRate; // 0x0c(0x04)
	...
	int32_t MaxEvalRateForInterpolation; // 0x20(0x04)
	char pad_24[0x4]; // 0x24(0x04)
	struct TArray<float> BaseVisibleDistanceFactorThesholds; // 0x28(0x10)
	struct TMap<int32_t, int32_t> LODToFrameSkipMap; // 0x38(0x50)
	int32_t SkippedUpdateFrames; // 0x88(0x04)
	int32_t SkippedEvalFrames; // 0x8c(0x04)
};
...
// ScriptStruct Engine.ExponentialHeightFogVolumetricLightingShadowsRange
// Size: 0x10 (Inherited: 0x00)
struct FExponentialHeightFogVolumetricLightingShadowsRange {
	float NearShadowMinimum; // 0x00(0x04)
	float FarShadowMinimum; // 0x04(0x04)
	float NearDistance; // 0x08(0x04)
	float FarDistance; // 0x0c(0x04)
};
...
// ScriptStruct Engine.InsideVolumeDistanceTest
// Size: 0x18 (Inherited: 0x00)
struct FInsideVolumeDistanceTest {
	struct FInsideVolumeOptionsMask InsideMask; // 0x00(0x04)
	float TestDistance; // 0x04(0x04)
	struct TArray<float> Distances; // 0x08(0x10)
};
...
struct FInstancedStaticMeshInstanceData {
	char pad_0[0x20]; // 0x00(0x20)
	struct TArray<struct UMaterialInterface*> wOverrideMaterials; // 0x20(0x10)
	struct FVector4 wCustomData[0x4]; // 0x30(0x40)
};
...
struct FLevelSimplificationDetails {
	...
	int32_t ScreenSize; // 0x08(0x04)
	bool bProcessLandscapeOnly; // 0x0c(0x01)
	char pad_D[0x3]; // 0x0d(0x03)
	struct FMaterialProxySettings StaticMeshMaterialSettings; // 0x10(0x88)
	bool bOverrideLandscapeExportLOD; // 0x98(0x01)
	char pad_99[0x3]; // 0x99(0x03)
	int32_t LandscapeExportLOD; // 0x9c(0x04)
	struct FMaterialProxySettings LandscapeMaterialSettings; // 0xa0(0x88)
	bool bBakeFoliageToLandscape; // 0x128(0x01)
	bool bBakeGrassToLandscape; // 0x129(0x01)
	bool bProcessLightingOnly; // 0x12a(0x01)
	bool bwIncludeFoliageMeshes; // 0x12b(0x01)
...
// ScriptStruct Engine.LightClippingPlane
// Size: 0x14 (Inherited: 0x00)
struct FLightClippingPlane {
	struct FRotator RelativeRotation; // 0x00(0x0c)
	float RelativeDistance; // 0x0c(0x04)
...
// ScriptStruct Engine.WCullingPlane
// Size: 0x14 (Inherited: 0x00)
struct FWCullingPlane {
	struct FRotator RelativeRotation; // 0x00(0x0c)
	float RelativeDistance; // 0x0c(0x04)
	float AttenuationDistance; // 0x10(0x04)
};
...
struct FMaterialSpriteElement {
	...
	float PivotOffsetX; // 0x1c(0x04)
	float PivotOffsetY; // 0x20(0x04)
	char pad_24[0x4]; // 0x24(0x04)
	struct UCurveFloat* DistanceToSizeCurve; // 0x28(0x08)
};
...
// ScriptStruct Engine.MaterialOverrideScalabitySettings
// Size: 0x10 (Inherited: 0x00)
struct FMaterialOverrideScalabitySettings {
	int32_t QualityLevelBitmask; // 0x00(0x04)
	char pad_4[0x4]; // 0x04(0x04)
...
struct FMeshProxySettings {
	...
	int32_t wLODNumber; // 0xa8(0x04)
	bool bwIncludeFoliageMeshes; // 0xac(0x01)
...
struct FMeshReductionSettings {
	...
	struct FPerPlatformInt ScreenSizeInPixels; // 0x0c(0x04)
	float PixelError; // 0x10(0x04)
	float WeldingThreshold; // 0x14(0x04)
	float HardAngleThreshold; // 0x18(0x04)
	int32_t BaseLODModel; // 0x1c(0x04)
	enum class EMeshFeatureImportance SilhouetteImportance; // 0x20(0x01)
	enum class EMeshFeatureImportance TextureImportance; // 0x21(0x01)
	enum class EMeshFeatureImportance ShadingImportance; // 0x22(0x01)
	char bRecalculateNormals : 1; // 0x23(0x01)
	char bGenerateUniqueLightmapUVs : 1; // 0x23(0x01)
	char bKeepSymmetry : 1; // 0x23(0x01)
	char bVisibilityAided : 1; // 0x23(0x01)
	char bCullOccluded : 1; // 0x23(0x01)
	char pad_23_5 : 3; // 0x23(0x01)
	enum class EStaticMeshReductionTerimationCriterion TerminationCriterion; // 0x24(0x01)
	enum class EMeshFeatureImportance VisibilityAggressiveness; // 0x25(0x01)
	enum class EMeshFeatureImportance VertexColorImportance; // 0x26(0x01)
	char pad_27[0x1]; // 0x27(0x01)
};
...
struct FPhysicsConstraintProfileHandle {
	struct FConstraintProfileProperties ProfileProperties; // 0x00(0x118)
	struct FName ProfileName; // 0x118(0x08)
};
...
struct FTViewTarget {
	...
	char pad_8[0x8]; // 0x08(0x08)
	struct FMinimalViewInfo POV; // 0x10(0x680)
	struct APlayerState* PlayerState; // 0x690(0x08)
...
// ScriptStruct Engine.CollidingGroupsDefinition
// Size: 0x50 (Inherited: 0x00)
struct FCollidingGroupsDefinition {
	struct TSet<struct FName> GroupNames; // 0x00(0x50)
};
...
struct FInputAxisKeyMapping {
	...
	struct FName GroupName; // 0x28(0x08)
	int32_t SortIndex; // 0x30(0x04)
	char pad_34[0x4]; // 0x34(0x04)
};
...
// ScriptStruct Engine.InputGroupHeader
// Size: 0x18 (Inherited: 0x00)
struct FInputGroupHeader {
	struct FName HeaderID; // 0x00(0x08)
	struct TArray<struct FName> GroupNames; // 0x08(0x10)
};
...
struct FSkeletalMeshLODInfo {
	...
	struct FPerPlatformInt ForceShadowProxyLOD; // 0x04(0x04)
	float LODHysteresis; // 0x08(0x04)
	char pad_C[0x4]; // 0x0c(0x04)
	struct TArray<int32_t> LODMaterialMap; // 0x10(0x10)
	struct FSkeletalMeshBuildSettings BuildSettings; // 0x20(0x14)
	struct FSkeletalMeshOptimizationSettings ReductionSettings; // 0x34(0x40)
	char pad_74[0x4]; // 0x74(0x04)
	struct TArray<struct FBoneReference> BonesToRemove; // 0x78(0x10)
	struct TArray<struct FBoneReference> BonesToPrioritize; // 0x88(0x10)
	...
	char bHasBeenSimplified : 1; // 0xc1(0x01)
	char bHasPerLODVertexColors : 1; // 0xc1(0x01)
	char bAllowCPUAccess : 1; // 0xc1(0x01)
	char bSupportUniformlyDistributedSampling : 1; // 0xc1(0x01)
...
struct FSkeletalMeshOptimizationSettings {
	...
	struct FPerPlatformInt ScreenSizeInPixels; // 0x18(0x04)
	enum class SkeletalMeshOptimizationType ReductionMethod; // 0x1c(0x01)
	enum class SkeletalMeshOptimizationImportance SilhouetteImportance; // 0x1d(0x01)
	enum class SkeletalMeshOptimizationImportance TextureImportance; // 0x1e(0x01)
	enum class SkeletalMeshOptimizationImportance ShadingImportance; // 0x1f(0x01)
	enum class SkeletalMeshOptimizationImportance SkinningImportance; // 0x20(0x01)
	struct FPerPlatformBool bRemapMorphTargets; // 0x21(0x01)
	char bRecalcNormals : 1; // 0x22(0x01)
	char pad_22_1 : 7; // 0x22(0x01)
	char pad_23[0x1]; // 0x23(0x01)
	float WeldingThreshold; // 0x24(0x04)
	float NormalsThreshold; // 0x28(0x04)
	int32_t MaxBonesPerVertex; // 0x2c(0x04)
	char bEnforceBoneBoundaries : 1; // 0x30(0x01)
	char pad_30_1 : 7; // 0x30(0x01)
	char pad_31[0x3]; // 0x31(0x03)
	float VolumeImportance; // 0x34(0x04)
	char bLockEdges : 1; // 0x38(0x01)
	char bLockColorBounaries : 1; // 0x38(0x01)
	char pad_38_2 : 6; // 0x38(0x01)
	char pad_39[0x3]; // 0x39(0x03)
	int32_t BaseLOD; // 0x3c(0x04)
};
...
struct FSkeletalMeshLODGroupSettings {
	...
	struct FSkeletalMeshOptimizationSettings ReductionSettings; // 0x40(0x40)
};
...
struct FStaticMeshSourceModel {
	...
	struct FMeshReductionSettings ReductionSettings; // 0x30(0x28)
	float LODDistance; // 0x58(0x04)
	struct FPerPlatformFloat ScreenSize; // 0x5c(0x04)
	struct FPerPlatformInt ForceShadowProxyLOD; // 0x60(0x04)
	char pad_64[0x4]; // 0x64(0x04)
	struct FString SourceImportFilename; // 0x68(0x10)
};
...
// ScriptStruct Engine.TextureOverride
// Size: 0x18 (Inherited: 0x00)
struct FTextureOverride {
	struct FName Texture; // 0x00(0x08)
	float Downscale; // 0x08(0x04)
	enum class TextureCompressionSettings CompressionSettings; // 0x0c(0x01)
	enum class TextureGroup LODGroup; // 0x0d(0x01)
	char pad_E[0x2]; // 0x0e(0x02)
	int32_t MaxTextureSize; // 0x10(0x04)
	enum class TextureMipGenSettings MipGenSettings; // 0x14(0x01)
	enum class ETextureMipLoadOptions MipLoadOptions; // 0x15(0x01)
	enum class ETexturePowerOfTwoSetting PowerOfTwoMode; // 0x16(0x01)
...
struct FTextureLODGroup {
	...
	bool ForceDisallowStreaming; // 0x65(0x01)
...
// ScriptStruct Engine.WindAffectedParameters
// Size: 0x24 (Inherited: 0x00)
struct FWindAffectedParameters {
	struct FName WindDirectionParameter; // 0x00(0x08)
	struct FName WindSpeedParameter; // 0x08(0x08)
	struct FName WindVelocityParameter; // 0x10(0x08)
	struct FName InsideParameter; // 0x18(0x08)
	char bSet_WindDirectionParameter : 1; // 0x20(0x01)
	char bSet_WindSpeedParameter : 1; // 0x20(0x01)
	char bSet_WindVelocityParameter : 1; // 0x20(0x01)
	char bSet_InsideParameter : 1; // 0x20(0x01)
	char pad_20_4 : 4; // 0x20(0x01)
	char pad_21[0x3]; // 0x21(0x03)
};
...
struct FHierarchicalSimplification {
	...
	char pad_9[0x3]; // 0x09(0x03)
	struct FMeshProxySettings ProxySetting; // 0x0c(0xb0)
	struct FMeshMergingSettings MergeSetting; // 0xbc(0xa0)
