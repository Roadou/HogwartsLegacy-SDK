...
struct FGrassVariety {
	...
	bool bReceivesWeatherDecals; // 0x51(0x01)
	char ReceivesWeatherDecalsMask; // 0x52(0x01)
	bool bCastDynamicShadow; // 0x53(0x01)
	bool bCastContactShadow; // 0x54(0x01)
	char pad_55[0x3]; // 0x55(0x03)
	struct TMap<enum class ESeasonEnum, struct TSoftObjectPtr<UStaticMesh>> OverrideMeshes; // 0x58(0x50)
	struct TArray<struct TSoftObjectPtr<UMaterialInterface>> SpringOverrideMaterials; // 0xa8(0x10)
	struct TArray<struct TSoftObjectPtr<UMaterialInterface>> SummerOverrideMaterials; // 0xb8(0x10)
	struct TArray<struct TSoftObjectPtr<UMaterialInterface>> FallOverrideMaterials; // 0xc8(0x10)
	struct TArray<struct TSoftObjectPtr<UMaterialInterface>> WinterOverrideMaterials; // 0xd8(0x10)
	bool bKeepInstanceBufferCPUCopy; // 0xe8(0x01)
...
// ScriptStruct Landscape.LandscapeSeasonParameters
// Size: 0x30 (Inherited: 0x00)
struct FLandscapeSeasonParameters {
	struct TArray<struct FLandscapeTextureSeason> TextureParameters; // 0x00(0x10)
	struct TArray<struct FLandscapeVectorParameterSeason> VectorParameters; // 0x10(0x10)
	struct TArray<struct FLandscapeScalarParameterSeason> ScalarParameters; // 0x20(0x10)
};

// ScriptStruct Landscape.LandscapeScalarParameterSeason
// Size: 0x18 (Inherited: 0x00)
struct FLandscapeScalarParameterSeason {
	struct FName ParameterName; // 0x00(0x08)
	float SpringScalarValue; // 0x08(0x04)
	float SummerScalarValue; // 0x0c(0x04)
	float FallScalarValue; // 0x10(0x04)
	float WinterScalarValue; // 0x14(0x04)
};

// ScriptStruct Landscape.LandscapeVectorParameterSeason
// Size: 0x48 (Inherited: 0x00)
struct FLandscapeVectorParameterSeason {
	struct FName ParameterName; // 0x00(0x08)
	struct FLinearColor SpringVectorValue; // 0x08(0x10)
	struct FLinearColor SummerVectorValue; // 0x18(0x10)
	struct FLinearColor FallVectorValue; // 0x28(0x10)
	struct FLinearColor WinterVectorValue; // 0x38(0x10)
};

// ScriptStruct Landscape.LandscapeTextureSeason
// Size: 0xa8 (Inherited: 0x00)
struct FLandscapeTextureSeason {
	struct FName ParameterName; // 0x00(0x08)
	struct TSoftObjectPtr<UTexture> SpringTexture; // 0x08(0x28)
	struct TSoftObjectPtr<UTexture> SummerTexture; // 0x30(0x28)
	struct TSoftObjectPtr<UTexture> FallTexture; // 0x58(0x28)
	struct TSoftObjectPtr<UTexture> WinterTexture; // 0x80(0x28)
};
