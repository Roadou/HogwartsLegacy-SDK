// BlueprintGeneratedClass BP_OL_SW_BogBank_A.BP_OL_SW_BogBank_A_C
// Size: 0x3f9 (Inherited: 0x3c0)
struct ABP_OL_SW_BogBank_A_C : ANone {
	...
	void UserConstructionScript(); // Function BP_OL_SW_BogBank_A.BP_OL_SW_BogBank_A_C.UserConstructionScript // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x38a7480
};
